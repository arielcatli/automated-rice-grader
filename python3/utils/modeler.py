        ...
        if os.path.exists(data_folder):
            ...
            if self.isHOG:
                ...
                for image in images:
                    ...
                    mask_image = cv2.threshold(cv2.GaussianBlur(gray, (7,7), 0),127,255, cv2.THRESH_OTSU + cv2.THRESH_BINARY)
...
##    bkn = Classifier(True)
##    bkn.add_model_dataset("../../training/bkn/data/bkn/", 1)
...
##    print(results[3])
##
##    red = Classifier(False)
##    red.add_model_dataset("../../training/red/data/red/", 1)
##    red.add_model_dataset("../../training/red/data/nred/", 0)
##    red.build_model_dataset("../../training/red/bins/", "red_dataset")
##    red.build_model("../../training/red/bins/","model_red")
##    red.add_test_dataset("../../testing/red/data/red/", 1)
##    red.add_test_dataset("../../testing/red/data/nred/", 0)
##    red.build_test_dataset("../../testing/red/bins/", "red_test_dataset")
##    results = red.test_classify("../../testing/red/results/nred/", "../../testing/red/results/red/")
##    print(results[2][0]/results[2][1])
##    print(results[3])
##    
#####    bkn.set_model("../../training/bkn/bins/model_bkn.bin")
...
##    ylw.add_dataset("../../img-src/62/ylw/")
##    ylw.classify("../../testing/ylw/results/nylw/", "../../testing/ylw/results/ylw/")
#######    
