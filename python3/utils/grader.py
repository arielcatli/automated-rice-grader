...
class Grader:
    def __init__(self):
        ...
        #load the datasets to the classifiers
        self.__load_datasets()

        #classification and transfer to respective folders
        self.__classify_color_hists()
    ...
    def __load_models(self):
        ...
        self.classifier_paddy.set_model("../../training/paddy/bins/model_paddy")
    ...
    def __load_datasets(self):
        self.classifier_bkn.add_dataset(self.sample_directory_extracted_p)
        self.classifier_ylw.add_dataset(self.sample_directory_extracted_p)
        self.classifier_paddy.add_dataset(self.sample_directory_extracted_p)
        self.classifier_grn.add_dataset(self.sample_directory_extracted_p)
        self.classifier_foreign.add_dataset(self.sample_directory_extracted_p)
        self.classifier_damaged.add_dataset(self.sample_directory_extracted_p)
        self.classifier_chalky.add_grains(self.sample_directory_extracted_p)
        
        
    def __classify_HOG(self):
        pass

    def __classify_color_hists(self):
